...
def get_args():
    ...
    parse.add_argument('-p', '--data_path', type=str, default='../FootballDataset/football_train/')
    parse.add_argument('-p2', '--data_path2', type=str, default='../FootballDataset/football_train/')
    parse.add_argument('-b', '--batch_size', type=int, default=16)
    parse.add_argument('-e', '--epochs', type=int, default=50)
